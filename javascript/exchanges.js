/*
scripts for the All Exchanges page
...
function reqListener () {
    /*
    parse data and use it to create a table
    */
...
function create_table(data) {
    ...
    */
    ...
    table.setAttribute("id", "exchanges_table")
...
function add_row(element) {
    ...
    */
    ...
    const header_row = document.getElementById("exchanges_table").tHead.rows[0]
...
function make_editable(cell) {
    ...
    */
    ...
    if ((row.getAttribute("active") != "true")) {
        ...
        const button = document.createElement("button")
        button.setAttribute("onclick", "save_row(this, '/api/exchange', 'exchange_id')")
